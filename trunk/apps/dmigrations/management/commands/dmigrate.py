...
from gareth53.apps.dmigrations.migration_state import MigrationState, table_present
from gareth53.apps.dmigrations.migration_db import MigrationDb
from gareth53.apps.dmigrations.exceptions import *
...
#            help='Verbosity level; 0=minimal, 1=normal output, 2=all output'),
    ...
    def handle(self, *args, **options):
        ...
        verbosity = 1 #int(options.get('verbosity', 1))
