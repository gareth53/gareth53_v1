...
from gareth53.apps.dmigrations.generator_utils import save_migration
...
migration_template = """from gareth53.apps.dmigrations.%(db_engine)s import migrations as m
import datetime
...
skeleton_template = """from gareth53.apps.dmigrations.%s import migrations as m
